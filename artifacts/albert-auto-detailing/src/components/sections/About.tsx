      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-display font-bold mb-6 text-white">{t.about.heading}</h3>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-border">
              <div>
                ...
                <div className="text-sm text-gray-400 uppercase tracking-wider">{t.about.stat1Label}</div>
              </div>
              <div>
                <div className="text-3xl font-display font-bold text-white mb-2">Premium</div>
                <div className="text-sm text-gray-400 uppercase tracking-wider">{t.about.stat2Label}</div>
              </div>
            </div>
          </motion.div>
        </div>
