      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-lg leading-relaxed mb-6 text-gray-700">{p1}</p>
            <p className="text-base leading-relaxed mb-8 text-gray-600">{p2}</p>
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-gray-200">
              <div>
                <div className="text-3xl font-display font-bold text-[#020C24] mb-2">{a.stat1Value}</div>
                <div className="text-sm uppercase tracking-wider text-gray-500">{stat1Label}</div>
              </div>
              <div>
                <div className="text-3xl font-display font-bold text-[#020C24] mb-2">{a.stat2Value}</div>
                <div className="text-sm uppercase tracking-wider text-gray-500">{stat2Label}</div>
              </div>
            </div>
          </motion.div>
        </div>
