...
export default function Contact() {
  ...
  const methods = [
    {
      icon: Phone,
      title: lang === "es" ? esMethods[0].title      : "Call Us",
      value: c.phone,
      href: `tel:${c.phone.replace(/\D/g, "")}`,
      actionText: lang === "es" ? esMethods[0].actionText : c.callLabel,
      show: !!c.phone,
    },
    {
      icon: Mail,
      title: lang === "es" ? esMethods[1].title      : "Email",
      value: c.email,
      href: `mailto:${c.email}`,
      actionText: lang === "es" ? esMethods[1].actionText : c.emailLabel,
      show: !!c.email,
    },
    {
      icon: Instagram,
      title: lang === "es" ? esMethods[2].title      : "Instagram",
      value: `@${c.instagram}`,
      href: `https://instagram.com/${c.instagram}`,
      actionText: lang === "es" ? esMethods[2].actionText : c.instagramLabel,
      show: !!c.instagram,
    },
  ].filter(m => m.show);
