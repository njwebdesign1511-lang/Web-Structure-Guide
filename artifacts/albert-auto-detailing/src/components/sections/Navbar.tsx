      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a
            ...
            className="px-5 py-2 bg-green-600 hover:bg-green-500 text-white text-sm font-bold tracking-wider uppercase transition-colors rounded-sm flex items-center gap-2"
          >
          ...
          >
            <nav className="flex flex-col py-6 px-6 gap-5">
              ...
              <a
                ...
                className="px-6 py-3 bg-primary text-white text-center text-sm font-bold tracking-wider uppercase hover:bg-primary/90 transition-colors rounded-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 bg-green-600 text-white text-center text-sm font-bold tracking-wider uppercase hover:bg-green-500 transition-colors rounded-sm"
              >
                WhatsApp
              </a>
            </nav>
