  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {showLogo && (
          <motion.div
            ...
            style={{ zIndex: 5, background: "#001830" }}
          >
            <motion.img
              src={logoImg}
      ...
      <div
        ...
        style={{
          zIndex: 1,
          background: "linear-gradient(105deg, rgba(2,12,36,0.62) 0%, rgba(2,12,36,0.28) 40%, rgba(2,12,36,0.04) 70%, transparent 100%)",
        }}
      />
      ...
      <div
        ...
        style={{ zIndex: 2, background: "linear-gradient(to top, rgba(2,12,36,0.55), transparent)" }}
      />
        ...
        <div className="max-w-2xl">
          ...
          <motion.div
            ...
            style={{
              height: "1px",
              width: "65%",
              background: "linear-gradient(to right, rgba(214,28,35,0.70), rgba(0,59,122,0.30), transparent)",
            }}
          />
