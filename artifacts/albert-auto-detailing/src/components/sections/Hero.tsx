  ...
  return (
    <section id="home" className="relative min-h-[100dvh] flex items-center pt-20" style={{ background: "#020C24" }}>
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to right, #020C24 0%, rgba(2,12,36,0.85) 50%, rgba(2,12,36,0.30) 100%)" }} />
        <div className="absolute inset-0" style={{ background: "rgba(2,12,36,0.45)" }} />
      </div>
