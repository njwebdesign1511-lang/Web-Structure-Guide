...
export default function AdminNav({ active, onChange }: Props) {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="px-4 py-5 mb-2" style={{ borderBottom: "1px solid rgba(20,96,160,0.12)" }}>
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-2">
        {groups.map(group => (
          <div key={group.label} className="mb-4">
            <p className="text-xs font-bold tracking-widest uppercase px-2 mb-1.5" style={{ color: "rgba(20,96,160,0.55)" }}>
              {group.label}
            </p>
      ...
      {/* Footer actions */}
      <div className="px-3 py-4" style={{ borderTop: "1px solid rgba(20,96,160,0.12)" }}>
        {saved && (
        ...
        <div className="flex gap-2">
          <a
            ...
            style={{ borderColor: "rgba(20,96,160,0.25)", color: "rgba(137,171,218,0.75)" }}
          >
  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ background: "#001020", borderRight: "1px solid rgba(20,96,160,0.12)" }}
      >
        <SidebarContent />
      </aside>
      ...
      <div
        ...
        style={{ background: "#001020", borderBottom: "1px solid rgba(20,96,160,0.12)" }}
      >
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 z-40 pt-14">
          ...
          <div className="relative w-64 h-full" style={{ background: "#001020" }}>
            <SidebarContent />
          </div>
        </div>
      )}
